      ...
      <div className="issues-container">
        <div className="section-header">
          ...
          <p className="section-description">
            এগুলি মূল বিষয় যা সমাধানে আমি প্রতিশ্রুতিবদ্ধ। আপনার কণ্ঠস্বর
            গুরুত্বপূর্ণ এবং একসাথে আমরা অর্থবহ পরিবর্তন সৃষ্টি করব।
          </p>
        </div>
        ...
        <div className="issues-cta">
          ...
          <p>
            আপনার মতামত আমাদের নীতি তৈরি করে। আপনার চিন্তা শেয়ার করুন এবং আরও
            ভাল সমাধান তৈরিতে আমাদের সাহায্য করুন।
          </p>
